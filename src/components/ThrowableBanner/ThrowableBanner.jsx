...
function makeInitialItems(assets, containerWidth = typeof window !== "undefined" ? window.innerWidth : 1200) {
  const items = [];
  let x = 0;
  let idx = 0;
...
export default function ThrowableBanner({ assets }) {
  const [items, setItems] = useState(() => makeInitialItems(assets));
